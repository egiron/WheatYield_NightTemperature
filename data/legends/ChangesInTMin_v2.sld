...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <se:Name>ChangeInTmin</se:Name>
    <UserStyle>
      <se:Name>ChangeInTmin</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>-0.5 - 0</se:Name>
          <se:Description>
            <se:Title>-0.5 - 0</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>TMinChangeGFill</ogc:PropertyName>
                <ogc:Literal>-0.48699999999999999</ogc:Literal>
              </ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>0 - 0.3</se:Name>
          <se:Description>
            <se:Title>0 - 0.3</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <se:Rule>
          <se:Name>0.3 - 0.6</se:Name>
          <se:Description>
            <se:Title>0.3 - 0.6</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>0.6 - 0.9</se:Name>
          <se:Description>
            <se:Title>0.6 - 0.9</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>0.9 - 1.2</se:Name>
          <se:Description>
            <se:Title>0.9 - 1.2</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>1.2 - 1.5</se:Name>
          <se:Description>
            <se:Title>1.2 - 1.5</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>1.5 - 1.8</se:Name>
          <se:Description>
            <se:Title>1.5 - 1.8</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>1.8 - 2.1</se:Name>
          <se:Description>
            <se:Title>1.8 - 2.1</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>2.1 - 2.4</se:Name>
          <se:Description>
            <se:Title>2.1 - 2.4</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>2.4 - 3.3</se:Name>
          <se:Description>
            <se:Title>2.4 - 3.3</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>TMinChangeGFill</ogc:PropertyName>
                <ogc:Literal>3.29999999999999982</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PointSymbolizer>
